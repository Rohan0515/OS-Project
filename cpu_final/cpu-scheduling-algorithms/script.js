...
function addProcess() {
    process++;
    let rowHTML1 = `
                          <td class="process-id" rowspan="2">C${process}</td>
                          ...
                          <td class="process-time cpu process-heading" colspan="">Engagement</td>
